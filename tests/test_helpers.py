...
from zero_trust_demo.app import (
    verify_password, generate_totp, verify_totp, 
    issue_access_token, issue_refresh_token, 
    abac_authorize, verify_jwt, USER_DB, REFRESH_TOKENS,
    AuthenticationError
)
...
def test_issue_access_token_structure():
    token = issue_access_token("alice", "admin", {"ip": "127.0.0.1", "device": "test-device"})
